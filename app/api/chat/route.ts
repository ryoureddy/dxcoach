...
${KNOWLEDGE_FILE}`;
  ...
  if (messages.length === 1) {
    ...
    if (mode === "practice" && caseId) {
      ...
      hiddenFirstMessage =
        "The student wants to practice with a generated case. Ask them what organ system, chief complaint, or clinical domain they want to work on, then generate a case and begin Phase 1.";
